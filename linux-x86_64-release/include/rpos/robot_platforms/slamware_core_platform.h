...
namespace rpos { namespace robot_platforms {
    ...
    public:
        ...
        bool getOptAreas(rpos::features::location_provider::RectangleAreaMap & map);
        bool addOptArea(const rpos::features::location_provider::RectangleAreaDescriptor & descriptor);
        bool addOptAreas(const rpos::features::location_provider::RectangleAreaMap  & map);
        bool removeOptAreaById(const std::vector<std::uint32_t> & ids);
        bool clearOptAreas(rpos::features::location_provider::MapKind mapKind = rpos::features::location_provider::MAINTENANCEAREAMAP);
