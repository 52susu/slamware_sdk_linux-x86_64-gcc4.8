...
namespace rpos {
    namespace features {
        ...
        public:
            ...
            bool getOptAreas(location_provider::RectangleAreaMap &);
            bool addOptArea(const location_provider::RectangleAreaDescriptor &);
            bool addOptAreas(const location_provider::RectangleAreaMap &);
            bool removeOptAreaById(const std::vector<std::uint32_t> & ids);
            bool clearOptAreas(location_provider::MapKind mapKind = location_provider::MAINTENANCEAREAMAP);
        };
