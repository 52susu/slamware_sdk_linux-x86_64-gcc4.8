    ...
    namespace artifact_provider
    {
        enum ArtifactUsage
        {
            ...
            */
            ...
            /**
            * Maintenance area has mutable environment, slamware will automatically rebuild map of this area
            */
        ...
        struct RPOS_CORE_API RectangleArea {
            ...
            RectangleAreaType type;
            uint32_t flag;
            std::vector<std::string> tags; 

            RectangleArea();
            RectangleArea(const rpos::core::Point &startP, const rpos::core::Point &endP, float halfWidth);
            RectangleArea(const rpos::core::ORectangleF &rect, rpos::core::SegmentID id, RectangleAreaType type); 
            ArtifactUsage getUsage() const;
        };
    }
